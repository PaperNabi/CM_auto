...
listener.on('message', msg => {
    ...
    if (msg.event === 'notification') {
        if (msg.data.type === 'mention') {
            ...
            const bong = ['촉수가 보인다. 어떻게 할까?\r  >공격\r  >관찰\r  >도주\r', '슬라임이 보인다. 어떻게 할까?\r  >공격\r  >관찰\r  >도주\r', '음마가 보인다. 어떻게 할까?\r  >공격\r  >관찰\r  >도주\r','보물상자가 보인다. 어떻게 할까?\r  >습득\r  >이동\r','별 달리 특별한 건 보이지 않는다. 어떻게 할까?\r  >재탐색\r  >이동']
